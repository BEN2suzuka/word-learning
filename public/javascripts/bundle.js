...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.memory-toggle-button').each(function (index, element) {
  ...
  button.click(function () {
    ...
    var nextmemory = (memory + 1) % 2;
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/wordgroups/".concat(wordGroupId, "/words/").concat(wordId, "/users/").concat(userId), {
      memory: nextmemory
    }, function (data) {
